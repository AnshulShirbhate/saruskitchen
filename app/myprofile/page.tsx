...
const ProfilePage = () => {
  ...
  return (
    <>
      ...
      <motion.div
        className="max-w-2xl w-full mx-auto my-8 bg-gradient-to-br from-white to-red-50 rounded-xl shadow-2xl p-4 sm:p-6 md:p-8 transition-all duration-300"
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.2 }}
      >
        <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-800 mb-6 text-center border-b pb-4 flex items-center justify-center gap-2">
        ...
        <div className="space-y-6">
          <div>
            <label className="text-sm font-medium text-gray-500 block mb-2">Old Password</label>
            <input
              type="password"
              name="oldPassword"
              ...
              className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-400 bg-gray-50 text-gray-700"
            />
          </div>

          <div>
            <label className="text-sm font-medium text-gray-500 block mb-2">New Password</label>
            <input
              type="password"
              name="newPassword"
          ...
          <div className="pt-4 flex justify-end">
            <motion.button
              ...
              className="flex items-center gap-2 bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700 transition-all"
            >
              <FiLock />
              Change Password
            </motion.button>
      ...
      {isPasswordModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          ...
          >
            <h2 className="text-lg font-bold mb-4 text-center">Confirm Password Change</h2>
