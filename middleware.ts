...
export async function middleware(req: NextRequest) {
  ...
  const protectedPaths = ['/cart', '/orders', '/api/orders', '/api/checkout', '/myprofile', '/api/customorder', '/custom-cakes', '/verify-email', '/api/verifyemail'];
